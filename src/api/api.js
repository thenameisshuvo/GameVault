...
// Prefer env var if provided, fallback to the existing key
const API =
  process.env.REACT_APP_RAWG_KEY || "30adeac360134ff987ca67c2c32de0ea";
...
//game details
// Include API key on details endpoint to avoid 401/403 responses
export const gameDetailsURL = (gameId) =>
  `${BASE_URL}/games/${gameId}?key=${API}`;
